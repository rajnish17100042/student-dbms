...
CREATE TABLE `student-dbms`.`notice_board` ( `id` INT(11) NOT NULL AUTO_INCREMENT , `name` VARCHAR(11) NOT NULL , `email` VARCHAR(11) NOT NULL , `group` VARCHAR(11) NOT NULL , `notice_date` VARCHAR(11) NOT NULL , `subject` VARCHAR(11) NOT NULL , `notice` TEXT NOT NULL , `issued_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`id`)) ENGINE = InnoDB;