  ...
  <section id="pricing">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
          <ul class="price">
            <li class="std-header">Standard</li>
            <li class="charge">$20</li>
            ...
            <li><strong>Free</strong> Setup</li>
            <li class="std-last-list">
              <a href="#" class="std-button">Order Now</a>
            </li>
          </ul>
        </div>
